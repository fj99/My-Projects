<?php
    ...
    { 
        ...
        $sql = "UPDATE parent SET ParentFirstName = $fname, ParentLastName = $lname, Parent_email = $email, Parent_Date_of_Birth = $DateB, Parent_Password = $pssd WHERE ParentID = $id AND username = $username ";
        //echo $sql;
    ...
    {
        $sql2 = "SELECT Parent_Date_of_Birth, Parent_Password FROM parent WHERE ParentID = $id AND username = '".$username."' ";
        $result2 = mysqli_query($conn, $sql2);
        $row = $result2->fetch_assoc(); 
        $Date = $row["Parent_Date_of_Birth"];
        $Pss = $row["Parent_Password"];
}
