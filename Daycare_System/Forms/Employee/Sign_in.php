...
$mysql_db  = get_db_connection($db_name);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($username_err) && empty($password_err)) {
    ...
    $sql = 'SELECT EmployeeID, username, Employee_Password FROM employee WHERE username = ?';
        ...
        if ($stmt->num_rows == 1) {
          ...
          if ($stmt->fetch()) {
            ...
            if (true) {
              ...
              $sql = "SELECT EmployeeFirstName, EmployeeLastName, Employee_Email FROM employee WHERE EmployeeID = '" . $id . "' ";
              ...
              $_SESSION['fname'] = $row["EmployeeFirstName"];
              $_SESSION['lname'] = $row["EmployeeLastName"];
  ...
  <main>
    <section class="container wrapper">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        ...
        <p>Don't have an account? <a href="Sign_up_Employee.php">Sign Up</a>.</p>
      </form>
      <br>
      <p class="text-center">
