<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username_err) && empty($password_err)) {
      ...
      $sql = 'SELECT ParentID, username, Parent_Password FROM Parent WHERE username = ?';
            ...
            if ($stmt->fetch()) 
            {
              //if (password_verify($password, $hashed_password)) {
                ...
                {           
                  ...
                  $sql = "SELECT ParentFirstName, ParentLastName, Parent_email FROM Parent WHERE ParentID = $id";
                  ...
                  $_SESSION['fname'] = $row["ParentFirstName"];
                  $_SESSION['lname'] = $row["ParentLastName"];
    ...
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Login</h2>
          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <p>Don't have an account? <a href="Sign_up_Parent.php">Sign in</a>.</p>
          </form>
          <br>
