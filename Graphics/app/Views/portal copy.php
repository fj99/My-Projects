...
<!-- 
  //! Make a style sheet separate from this file
  <style>
      ...
      <div id="Head" class="table-wrap fixTableHead">
        <table class="table">
          <thead class="thead-primary">
            <tr>
              <th>View</th>
              <!-- <th class="popup" onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('id')"> -->
              ...
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('user')">
                <p class="popuptext" id="myPopup4">Sort by Clicking</p>
                User
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('date')">
                <p class="popuptext" id="myPopup5">Sort by Clicking</p>
                Date Submitted
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('requested_completion_date')">
                <p class="popuptext" id="myPopup6">Sort by Clicking</p>
                Deadline
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('completed_date')">
                <p class="popuptext" id="myPopup7">Sort by Clicking</p>
                Date Completed
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('assigned_to')">
                <p class="popuptext" id="myPopup8">Sort by Clicking</p>
                Assigned To
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('req_status')">
                <p class="popuptext" id="myPopup9">Sort by Clicking</p>
                Request Status
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('complete')">
          ...
          <tbody id="card">
            ...
            foreach ($graphics->getResult() as $row) {
              ...
              echo "<tr>";
              echo "<td><a href='view/$id?status=$status'>Click Here</a></td>";
              echo "<td>$id</td>";
              echo "<td>$fname</td>";
              echo "<td>$lname</td>";
              echo "<td>$user</td>";
            ...
            ?>
              <td>
                <!--
                  //? Make a Table that holds all the graphic designers maybe have it all in history and then have a status column 
                -->
      ...
      <div class="table-wrap fixTableHead">
        <table class="table">
          <thead class="thead-primary">
            <tr>
              <th>View</th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('id')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                ID
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('first_name')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                First Name
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('last_name')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                Last Name
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('user')">
              ...
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('requested_deadline')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                Deadline
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('completion_date')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                Date Completed
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('assigned_to')">
              ...
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('request_status')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                Request Status
              </th>
              <th onmouseover="mouseOver()" onmouseout="mouseOut()" onclick="Sort('completed_accepted_or_denied')">
                <p class="popuptext" id="myPopup">Sort by Clicking</p>
                Completed
              </th> 
              </tr>
          ...
          <tbody id="form">
            ...
            foreach ($printing->getResult() as $row2) {
              ...
              // $comp_date = $row2->completion_date;
              // $assigned_to = $row2->assigned_to;
              // $req_status = $row2->request_status;
